...
test_that("Tracing failures works with drop.unchanged.args == TRUE", {
  ...
  result <- trace_failures(traceable_fun, drop.unchanged.args = TRUE)
...
test_that("Tracing failures works with drop.unchanged.args == FALSE", {
